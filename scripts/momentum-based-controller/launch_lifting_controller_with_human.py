...
def termination():
    ...
    human_robot_interface.robotDriver.close()
...
if use_logger:
    ...
    logger.add_data_variables(['t', 'p_com', 'p_com_des', 'v_com', 'v_com_des', 'ang_mom', 'ang_mom_des', 'joint_pos', 'joint_pos_des', 'tau', 'f', 'joint_pos_human', 'H_robot', 'H_human', 'H_robot_des'])
...
while True:
    ...
    if use_logger:
        ...
        logger_data = { 't' : t,
                        ...
                        'tau' : tau, 'f' : f, 'joint_pos_human' : human_s,
                        'H_robot': base_pose, 'H_human' : human_base_pose,
                        'H_robot_des': H_des}
